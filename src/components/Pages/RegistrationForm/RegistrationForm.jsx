...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Sử dụng local datetime string để tránh timezone conversion
  ...
  const getDisplayDateTime = () => {
    ...
    if (
      ...
      try {
        // Tạo date object từ local date string để tránh timezone issues
        const [year, month, day] = submittedFormData.appointmentDate
          .split("-")
          .map(Number);
